...
export const UPLOAD_LIMITS = {
  ...
  TASK_ATTACHMENT_TYPES: ["application/pdf", "image/png", "image/jpeg", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"],
...
export const DOCUMENT_TEMPLATE_FIELDS = {
  SURAT_UNDANGAN: [
    ...
    { key: "kepada", label: "Kepada Yth. (nama & jabatan)", type: "textarea", required: true },
    { key: "diTempat", label: "di", type: "text", required: false },
    { key: "isiUndangan", label: "Pengantar / Isi Undangan", type: "textarea", required: true },
    ...
    { key: "namaSekretaris", label: "Nama Sekretaris", type: "text", required: false },
    { key: "nimSekretaris", label: "NIM Sekretaris", type: "text", required: false },
  ],
  NOTULEN_RAPAT: [
    ...
    { key: "waktuSelesai", label: "Waktu Selesai", type: "text", required: false },
    { key: "tempat", label: "Tempat", type: "text", required: true },
    { key: "pemimpinRapat", label: "Pemimpin Rapat", type: "text", required: true },
    { key: "notulis", label: "Notulis", type: "text", required: true },
    { key: "pesertaHadirIds", label: "Peserta Hadir", type: "attendees", required: true },
    { key: "pesertaTidakHadir", label: "Peserta Tidak Hadir (opsional)", type: "textarea", required: false },
    { key: "agenda", label: "Agenda Rapat", type: "textarea", required: true },
    { key: "pembahasan", label: "Pembahasan", type: "textarea", required: true },
    { key: "hasilRapat", label: "Keputusan / Kesimpulan", type: "textarea", required: true },
    { key: "tindakLanjut", label: "Tindak Lanjut", type: "textarea", required: false },
  ],
  DAFTAR_HADIR: [
  ...
  LPJ: [
    { key: "namaKegiatan", label: "Nama Kegiatan", type: "text", required: true },
    { key: "landasan", label: "Landasan / Dasar Pelaksanaan", type: "textarea", required: false },
    ...
    { key: "susunanPanitia", label: "Susunan Panitia", type: "textarea", required: false },
    { key: "uraianKegiatan", label: "Uraian Kegiatan", type: "textarea", required: true },
    { key: "hambatan", label: "Hambatan / Kendala", type: "textarea", required: false },
    { key: "evaluasi", label: "Evaluasi", type: "textarea", required: true },
    { key: "rekomendasi", label: "Rekomendasi", type: "textarea", required: false },
    { key: "totalPemasukan", label: "Total Pemasukan (Rp)", type: "number", required: false },
    { key: "totalPengeluaran", label: "Total Pengeluaran (Rp)", type: "number", required: false },
    { key: "namaKetua", label: "Nama Ketua Pelaksana", type: "text", required: true },
    { key: "nimKetua", label: "NIM Ketua", type: "text", required: true },
    { key: "namaSekretaris", label: "Nama Sekretaris", type: "text", required: false },
    { key: "nimSekretaris", label: "NIM Sekretaris", type: "text", required: false },
  ],
